...
#########################
# 网络结构
from networks import VGGNet, FCNs
# 训练流程架构
...
fcn_model = FCNs(pretrained_net=vgg_model, n_class=class_num)

solver = MyFrame(vgg_model, fcn_model, class_num, metric, learning_rate)
# 模型参数量打印及记录
